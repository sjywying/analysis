...
import com.analysis.calculate.active.ActiveParserBolt;
import com.analysis.calculate.common.spring.SpringApplicationContextFactory;

public class NginxFilterBolt implements IRichBolt {
	
	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = LoggerFactory.getLogger(NginxFilterBolt.class);
