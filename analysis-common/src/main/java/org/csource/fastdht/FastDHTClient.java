...
public class FastDHTClient {
        ...
        /**
         * @param bMultiThread
         *                if use in multi-thread
         */
        public FastDHTClient(boolean bMultiThread) {
                if (bMultiThread) {
                        this.serverGroup = (ServerGroup) ClientGlobal.serverGroup.clone();
                } else {
                        this.serverGroup = ClientGlobal.serverGroup;
                }
        }
         ...
         */
        public int set(KeyInfo keyInfo, String value) throws Exception {
                return this.set(keyInfo, value.getBytes(ClientGlobal.charset), ProtoCommon.FDHT_EXPIRES_NEVER);
        }
         ...
         * @return 0 for success, != 0(errno) for fail
         */
        public int set(KeyInfo keyInfo, byte[] value) throws Exception {
         ...
         *                value of the key
         * @param expires
         *                expire timestamp, ProtoCommon.FDHT_EXPIRES_NEVER for
         *                never expired
         * @return 0 for success, != 0(errno) for fail
         */
        public int set(KeyInfo keyInfo, String value, int expires) throws Exception {
                return this.set(keyInfo, value.getBytes(ClientGlobal.charset), expires);
        }
         ...
         * @return 0 for success, != 0(errno) for fail
         */
        public int set(KeyInfo keyInfo, byte[] value, int expires) throws Exception {
                ServerInfo server;
                ...
                try {
                        ...
                        System.err.println("server " + server.address.getAddress().getHostAddress() + ":"
                                        + server.address.getPort() + " IOException, error msg: " + ex.getMessage());
         ...
         */
        public int delete(KeyInfo keyInfo) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
         ...
         */
        public String get(KeyInfo keyInfo) throws Exception {
         ...
         *                the key to get
         * @param expires
         *                expire timestamp, ProtoCommon.FDHT_EXPIRES_NONE for
         *                not change the expired time
         * @return none null for success, null for fail
         */
        public String get(KeyInfo keyInfo, int expires) throws Exception {
                byte[] bs;
                ...
                return new String(bs, ClientGlobal.charset);
        }
         ...
         * @return none null for success, null for fail
         */
        public byte[] getBytes(KeyInfo keyInfo) throws Exception {
         ...
         * @return none null for success, null for fail
         */
        public byte[] getBytes(KeyInfo keyInfo, int expires) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
                int value_len;
        ...
        public Long inc(KeyInfo keyInfo, int increment) throws Exception {
         ...
         * @return none null for success, null for fail
         */
        public Long inc(KeyInfo keyInfo, int increment, int expires) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
                int offset;
        ...
        private int parseBatchUpdate(int src_key_count, ServerInfo server, ProtoCommon.PkgInfo pkgInfo, Map failKeys)
                ...
                if (pkgInfo.body.length < 8 + 5 * src_key_count) {
                        System.err.println("server " + server.address.getAddress().getHostAddress() + ":"
                                        + server.address.getPort() + " body length: " + pkgInfo.body.length + " < "
                                        + (8 + 5 * src_key_count));
                ...
                if (key_count != src_key_count) {
                        System.err.println("server " + server.address.getAddress().getHostAddress() + ":"
                                        + server.address.getPort() + " key count: " + key_count + " != "
                                        + src_key_count);
                ...
                for (int i = 0; i < key_count; i++) {
                        ...
                        offset += 4;
                        key = new String(pkgInfo.body, offset, key_len, ClientGlobal.charset);
         ...
         * 
         * @param objInfo
         *                object info, including namespace and object id
         * @param keyValues
         *                key value pair, key and value's type is String
         * @param failKeys
         *                fail key, key 's type is String and value's type is
         *                Integer
         * @return success set key count, < 0 for all keys fail
         */
        public int batchSet(ObjectInfo objInfo, Map keyValues, Map failKeys) throws Exception {
        ...
        public int batchSet(ObjectInfo objInfo, Map keyValues, Map failKeys, int expires) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
                int offset;
                ...
                try {
                        ...
                        while (it.hasNext()) {
                                ...
                                header.body_len += 8 + key.getBytes(ClientGlobal.charset).length
                                                + value.getBytes(ClientGlobal.charset).length;
                        }
                        ...
                        while (it.hasNext()) {
                                ...
                                bsKey = key.getBytes(ClientGlobal.charset);
                                bsValue = value.getBytes(ClientGlobal.charset);
         ...
         * @return success set key count, < 0 for all keys fail
         */
        public int batchDelete(ObjectInfo objInfo, String[] keys, Map failKeys) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
                int offset;
                ...
                try {
                        ...
                        for (i = 0; i < keys.length; i++) {
                                header.body_len += 4 + keys[i].getBytes(ClientGlobal.charset).length;
                        }
                        ...
                        for (i = 0; i < keys.length; i++) {
                                bsKey = keys[i].getBytes(ClientGlobal.charset);
         ...
         */
        public Hashtable batchGet(ObjectInfo objInfo, String[] keys, Map failKeys) throws Exception {
         ...
         * @return none null for success, null for all keys fail
         */
        public Hashtable batchGet(ObjectInfo objInfo, String[] keys, Map failKeys, int expires) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
                int offset;
                ...
                try {
                        ...
                        for (i = 0; i < key_count; i++) {
                                ...
                                if (status == 0) {
                                        ...
                                        offset += 4;
                                        value = new String(pkgInfo.body, offset, value_len, ClientGlobal.charset);
        ...
        public Hashtable stat(int server_index) throws Exception {
                ...
                try {
                        ...
                        String szBody = new String(pkgInfo.body, ClientGlobal.charset);
         ...
         */
        public String[] getSubKeys(ObjectInfo objInfo) throws Exception {
                ServerInfo server;
                ProtoCommon.PkgHeader header;
                byte[] bsPackage;
                byte status;
                ...
                try {
                        ...
                        String szSubKeys = new String(pkgInfo.body, ClientGlobal.charset);
