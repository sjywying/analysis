...
public class FastDHTClient {
     ...
     * @param keyInfo the key to set
     * @param value   value of the key
     * @param expires expire timestamp, ProtoCommon.FDHT_EXPIRES_NEVER for
     *                never expired
     * @return 0 for success, != 0(errno) for fail
     */
     ...
     *
     * @param keyInfo the key to get
     * @param expires expire timestamp, ProtoCommon.FDHT_EXPIRES_NONE for
     ...
     * @param failKeys  fail key, key 's type is String and value's type is
     *                  Integer
