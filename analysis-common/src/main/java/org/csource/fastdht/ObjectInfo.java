...
public class ObjectInfo {
    ...
    public ObjectInfo(byte[] namespace, byte[] object_id) throws Exception {
        this.namespace = namespace;
        this.object_id = object_id;
        this.check();
    }

    public ObjectInfo(String namespace, String object_id) throws Exception {
    ...
    public int getHashCode() {
        ...
        key_hash_code = Hash.PJWHash(hash_key, 0, hash_key.length);
        if (key_hash_code < 0) {
