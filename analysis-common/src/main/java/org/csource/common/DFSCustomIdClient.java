...
public class DFSCustomIdClient {
         ...
         * 
         * @param trackerServer
         *                the FastDFS tracker server, can be null
         * @param storageServer
         *                the FastDFS storage server, can be null
         * @param serverGroup
         *                the FastDHT group info
         * @param fdhtNamespace
         *                the FastDHT namespace
         */
         ...
         * 
         * @param fdfsConfigFilename
         *                the FastDFS config filename
         * @param fdhtConfigFilename
         *                the FastDHT config filename
         * @throws Exception
         */
         ...
         * 
         * @param keyInfo
         *                the FastDHT key object
         * @return true for not exist, otherwise false
         * @throws Exception
         *                 checkFdfsFileIdNotExit
         */
         ...
         *                the appender file id specified by application
         * @param group_name
         *                the group name to upload appender file to, can be
         *                empty
         * @param local_filename
         *                local filename to upload
         * @param file_ext_name
