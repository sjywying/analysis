...
public class StorageClient {
    ...
    protected String[] do_upload_file(byte cmd, String group_name, String master_filename,
        ...
        try {
            ...
            if (file_ext_name != null && file_ext_name.length() > 0) {
                byte[] bs = file_ext_name.getBytes(ClientGlobal.charset);
            ...
            if (bUploadSlave) {
                masterFilenameBytes = master_filename.getBytes(ClientGlobal.charset);
            ...
            if (bUploadSlave) {
                ...
                byte[] bs = prefix_name.getBytes(ClientGlobal.charset);
    ...
    protected int do_append_file(String group_name, String appender_filename,
        ...
        try {
            ...
            appenderFilenameBytes = appender_filename.getBytes(ClientGlobal.charset);
    ...
    public NameValuePair[] get_metadata(String group_name, String remote_filename) throws IOException, FastDFSException {
        ...
        try {
            ...
            return ProtoCommon.split_metadata(new String(pkgInfo.body, ClientGlobal.charset));
        } catch (IOException ex) {
            if (!bNewConnection) {
                try {
                    this.storageServer.close();
    ...
    public int set_metadata(String group_name, String remote_filename,
        ...
        try {
            ...
            if (meta_list == null) {
                ...
                meta_buff = ProtoCommon.pack_metadata(meta_list).getBytes(ClientGlobal.charset);
            }

            filenameBytes = remote_filename.getBytes(ClientGlobal.charset);
            sizeBytes = new byte[2 * ProtoCommon.FDFS_PROTO_PKG_LEN_SIZE];
            ...
            bs = group_name.getBytes(ClientGlobal.charset);
